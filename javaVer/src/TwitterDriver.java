...
import java.util.Scanner;
   ...
   public class TwitterDriver {
      ...
      public static void main (String []args) throws TwitterException, IOException, InterruptedException {
         ...
         // checkDms();
         // checkStockTrades();
         sendTweet("new test", twtBot);
      }
      
      public static void sendTweet(String s, Twitterer twtBot) throws TwitterException, IOException{
         twtBot.tweetOut(s);
      }

      public static void checkStockTrades(){
      ...
      /**
       * method that will check for new DMs every 15 seconds
       * @throws TwitterException
       * @throws IOException
       * @throws InterruptedException
       */
      public static void checkDms(Twitterer twtBot) throws TwitterException, IOException, InterruptedException {
      ...
      public static void readStockCommand(String recentDmText){
         ...
         try{
            ...
            System.out.printf("Action: %s Shares: %d Ticker: %s\n", action, numShares, ticker);
         } 
